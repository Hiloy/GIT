...
class __TwigTemplate_cba019e34e1f83838e2680d71b00fce7a25a5024ed4829cb5c2f192c307524eb extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid pb-5\">
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "\" class=\"btn btn-primary mb-1\"><i class=\"fa fa-shopping-cart\"></i></button>
                                            <a href=\"";
                // line 61
                            ...
                            <table class=\"table table-bordered table-hover\">
                                ...
                                {% for product in products %}
                                    <tr>
                                        ...
                                        <td class=\"text-center\"><button type=\"button\" onclick=\"cart.add('{{ product.product_id }}');\" data-toggle=\"tooltip\" title=\"{{ button_cart }}\" class=\"btn btn-primary mb-1\"><i class=\"fa fa-shopping-cart\"></i></button>
