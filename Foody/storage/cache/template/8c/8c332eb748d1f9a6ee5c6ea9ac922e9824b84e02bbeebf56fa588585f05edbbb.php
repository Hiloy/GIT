...
class __TwigTemplate_911d26d11ae31bf006af80c2c874674054c78a34eac442ca13967b838e5d8781 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid pb-5\">
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "\" class=\"btn btn-primary mb-7\"><i class=\"fa fa-shopping-cart\"></i></button>
                                            <a href=\"";
                // line 61
                            ...
                            <table class=\"table table-bordered table-hover\">
                                ...
                                {% for product in products %}
                                    <tr>
                                        ...
                                        <td class=\"text-center\"><button type=\"button\" onclick=\"cart.add('{{ product.product_id }}');\" data-toggle=\"tooltip\" title=\"{{ button_cart }}\" class=\"btn btn-primary mb-7\"><i class=\"fa fa-shopping-cart\"></i></button>
