...
class __TwigTemplate_dc20062624472039789952b5d1f53eeeefac80b3ae5ed380f8d3727b27cbd4b4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid pb-5\">
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "\" class=\"btn btn-primary mb-4\"><i class=\"fa fa-shopping-cart\"></i></button>
                                            <a href=\"";
                // line 61
                            ...
                            <table class=\"table table-bordered table-hover\">
                                ...
                                {% for product in products %}
                                    <tr>
                                        ...
                                        <td class=\"text-center\"><button type=\"button\" onclick=\"cart.add('{{ product.product_id }}');\" data-toggle=\"tooltip\" title=\"{{ button_cart }}\" class=\"btn btn-primary mb-4\"><i class=\"fa fa-shopping-cart\"></i></button>
