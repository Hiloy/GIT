...
class __TwigTemplate_a4408af7125dc266f34354d59e064eb35396af843ebb13ebc7975eaf1562fea6 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        echo "\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
          <fieldset>
            <div class=\"form-group required\">
              <label class=\"col-sm-2 control-label\" for=\"input-firstname\"><h5>";
        // line 32
    ...
    <div id=\"content\" class=\"{{ class }}\">{{ content_top }}
      <div class=\"bg-light p-30 mb-5\">
        ...
        <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
          <fieldset>
            <div class=\"form-group required\">
              <label class=\"col-sm-2 control-label\" for=\"input-firstname\"><h5>{{ entry_firstname }}</h5></label>
              <div class=\"col-sm-10\">
