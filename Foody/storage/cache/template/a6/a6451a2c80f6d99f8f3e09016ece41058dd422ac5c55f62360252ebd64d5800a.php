...
class __TwigTemplate_090fe764ffcc3e9c8dbcc34b8c4b551a2f4d9529ffcae70bba9ee5ffb7e1c87e extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"bg-light p-30 mb-5\" >
        ...
        echo "              </div>
            ...
            <div class=\"form-group required\">
              <h4 class=\"col-sm-2 control-label row\" for=\"input-confirm\">";
        // line 42
      ...
      <div class=\"bg-light p-30 mb-5\" >
        ...
        <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
          <fieldset>
            ...
            <div class=\"form-group required\">
              <h4 class=\"col-sm-2 control-label row\" for=\"input-confirm\">{{ entry_confirm }}</h4>
              <div class=\"col-sm-10\">
