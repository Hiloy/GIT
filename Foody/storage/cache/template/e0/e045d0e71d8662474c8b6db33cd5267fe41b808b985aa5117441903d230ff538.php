...
class __TwigTemplate_7ee245b0a1506fadc6b672e3b0a0efdd8fcbff94096f109fa8b82b8fc578a7aa extends \Twig\Template
{
    private $source;
    private $macros = [];
                            ...
                            <table class=\"table table-bordered table-hover\">
                                ...
                                {% for product in products %}
                                    <tr>
                                        ...
                                        <td class=\"text-center\"><button type=\"button\" onclick=\"cart.add('{{ product.product_id }}');\" data-toggle=\"tooltip\" title=\"{{ button_cart }}\" class=\"btn btn-primary\"><i class=\"fa fa-shopping-cart\"></i></button>
