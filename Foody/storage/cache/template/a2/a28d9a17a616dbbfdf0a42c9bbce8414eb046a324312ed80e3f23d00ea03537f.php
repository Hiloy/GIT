...
class __TwigTemplate_33fd5d1c86b165e46017e0de294614cb90e70ce2d339afa8ad66410ee636bbbc extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        echo "\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
          <fieldset>
            <div class=\"form-group required\">
              <label class=\"col-sm-2 control-label\" for=\"input-firstname\"><h6>";
        // line 32
    ...
    <div id=\"content\" class=\"{{ class }}\">{{ content_top }}
      <div class=\"bg-light p-30 mb-5\">
        ...
        <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
          <fieldset>
            <div class=\"form-group required\">
              <label class=\"col-sm-2 control-label\" for=\"input-firstname\"><h6>{{ entry_firstname }}</h6></label>
              <div class=\"col-sm-10\">
