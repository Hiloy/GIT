...
class __TwigTemplate_6fbe23e879d710e40671339e0cc98fbbbfd87241bac029d497180f7771613910 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"bg-light p-30 mb-5\">
        ...
        echo "\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
          <fieldset>
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-firstname\">";
        // line 32
        ...
        echo " </div>
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-lastname\">";
        // line 40
        ...
        echo " </div>
            ...
            <div class=\"form-group\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-company\">";
        // line 48
        ...
        echo "\" id=\"input-company\" class=\"form-control\" />
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-address-1\">";
        // line 54
        ...
        echo " </div>
            ...
            <div class=\"form-group\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-address-2\">";
        // line 62
        ...
        echo "\" id=\"input-address-2\" class=\"form-control\" />
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-city\">";
        // line 68
        ...
        echo " </div>
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-postcode\">";
        // line 76
        ...
        echo " </div>
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-country\">";
        // line 84
        ...
        echo " </div>
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-zone\">";
        // line 107
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["custom_field"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["custom_field"], "type", [], "any", false, false, false, 116) == "select")) {
                ...
                echo "\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-custom-field";
                // line 118
    ...
    <div id=\"content\" class=\"{{ class }}\">{{ content_top }}
      <div class=\"bg-light p-30 mb-5\">
        ...
        <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
          <fieldset>
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-firstname\">{{ entry_firstname }}</h5>
              <div class=\"col-sm-10\">
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-lastname\">{{ entry_lastname }}</h5>
              <div class=\"col-sm-10\">
            ...
            <div class=\"form-group\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-company\">{{ entry_company }}</h5>
              <div class=\"col-sm-10\">
                <input type=\"text\" name=\"company\" value=\"{{ company }}\" placeholder=\"{{ entry_company }}\" id=\"input-company\" class=\"form-control\" />
              </div>
            </div>
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-address-1\">{{ entry_address_1 }}</h5>
              <div class=\"col-sm-10\">
            ...
            <div class=\"form-group\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-address-2\">{{ entry_address_2 }}</h5>
              <div class=\"col-sm-10\">
                <input type=\"text\" name=\"address_2\" value=\"{{ address_2 }}\" placeholder=\"{{ entry_address_2 }}\" id=\"input-address-2\" class=\"form-control\" />
              </div>
            </div>
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-city\">{{ entry_city }}</h5>
              <div class=\"col-sm-10\">
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-postcode\">{{ entry_postcode }}</h5>
              <div class=\"col-sm-10\">
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-country\">{{ entry_country }}</h5>
              <div class=\"col-sm-10\">
                <select name=\"country_id\" id=\"input-country\" class=\"form-control\">
            ...
            <div class=\"form-group required\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-zone\">{{ entry_zone }}</h5>
              <div class=\"col-sm-10\">
                <select name=\"zone_id\" id=\"input-zone\" class=\"form-control\">
                </select>
                {% if error_zone %}
            ...
            <div class=\"form-group{% if custom_field.required %} required {% endif %} custom-field\" data-sort=\"{{ custom_field.sort_order }}\">
              <h5 class=\"col-sm-2 control-h5\" for=\"input-custom-field{{ custom_field.custom_field_id }}\">{{ custom_field.name }}</h5>
              <div class=\"col-sm-10\">
            ...
            <div class=\"form-group{% if custom_field.required %} required {% endif %} custom-field\" data-sort=\"{{ custom_field.sort_order }}\">
              <h5 class=\"col-sm-2 control-h5\">{{ custom_field.name }}</h5>
              <div class=\"col-sm-10\">
            ...
            {% endfor %}
            <div class=\"form-group\">
              <h5 class=\"col-sm-2 control-h5\">{{ entry_default }}</h5>
