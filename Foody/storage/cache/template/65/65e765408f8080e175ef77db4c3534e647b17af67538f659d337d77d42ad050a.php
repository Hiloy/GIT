...
class __TwigTemplate_d0e43e8a5ad323405ebc4d8c6a612ce691d444f7055c08d16b9a450dd37bcc16 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"bg-light p-30 mb-5\" >
        ...
        echo "              </div>
            ...
            <div class=\"form-group required\">
              <h4 class=\"col-sm-2 control-label text-nowrap\" for=\"input-confirm\">";
        // line 42
      ...
      <div class=\"bg-light p-30 mb-5\" >
        ...
        <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" class=\"form-horizontal\">
          <fieldset>
            ...
            <div class=\"form-group required\">
              <h4 class=\"col-sm-2 control-label\" for=\"input-password\">{{ entry_password }}</h4>
              <div class=\"col-sm-10\">
            ...
            <div class=\"form-group required\">
              <h4 class=\"col-sm-2 control-label text-nowrap\" for=\"input-confirm\">{{ entry_confirm }}</h4>
              <div class=\"col-sm-10\">
