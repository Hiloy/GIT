...
class __TwigTemplate_270c698d33d56b7828e36ff24135ad99896994215a34aa36360c8227a43beff1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<body>
    ...
    <div class=\"container-fluid\">
        ...
        echo "\" class=\"btn px-0 ml-2\">
                        ...
                        <span class=\"badge text-dark border border-dark rounded-circle\" style=\"padding-bottom: 2px;\" id=\"wishlist-total\">";
        // line 73
            ...
            <div class=\"col-lg-6 text-center text-lg-right\">
                ...
                <div class=\"d-inline-flex align-items-center\">
                    <a href=\"{{ whishlist }}\" class=\"btn px-0 ml-2\">
                        <i class=\"fas fa-heart text-dark\"></i>
                        <span class=\"badge text-dark border border-dark rounded-circle\" style=\"padding-bottom: 2px;\" id=\"wishlist-total\">{{ text_whishlist }}</span>
                    </a>
