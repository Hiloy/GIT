...
class __TwigTemplate_0f0b0c75a02a01a1675573d29cabf0279b15668246ad4763fd23fe22b3e25b84 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo " col-sm-6 pb-1\">
                               ";
                // line 143
                $this->loadTemplate("multishop/template/product_card.twig", "Foody/template/product/category.twig", 143)->display($context);
                // line 144
                echo "                            </div>
                        ";
                ++$context['loop']['index0'];
                    ...
                    {% if products %}
                        {% for product in products %}
                            <div class=\"{{ card }} col-sm-6 pb-1\">
                               {% include 'multishop/template/product_card.twig' %}
                            </div>
                        {% endfor %}
