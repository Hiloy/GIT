...
class __TwigTemplate_024b83a6d208713dd3f2abd125a6bfd00277745ea409de8623f44d1253a97e1b extends \Twig\Template
{
    private $source;
    private $macros = [];
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["option"], "type", [], "any", false, false, false, 99) == "radio")) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                        ...
                        echo "                              <div class=\"custom-control custom-radio custom-control-inline\">
                                  <input type=\"radio\" class=\"custom-control-input\" id=\"option-";
                        // line 104
                        ...
                        echo twig_get_attribute($this->env, $this->source, $context["option"], "product_option_id", [], "any", false, false, false, 104);
                        echo "\" value=\"";
                        echo twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 104);
                        echo "\">
                    ...
                    {% if options %}
                      ...
                      {% for option in options %}
                        ...
                        {% if option.type == 'radio' %}
                          <div class=\"d-flex mb-3 {% if option.required %} required {% endif %}\" id=\"input-option{{ option.product_option_id }}\">
                            <strong class=\"text-dark mr-3\">Sizes:</strong>
                            {% for option_value in option.product_option_value %}
                              <div class=\"custom-control custom-radio custom-control-inline\">
                                  <input type=\"radio\" class=\"custom-control-input\" id=\"option-{{ option.product_option_id }}{{ loop.index }}\" name=\"option{{ option.product_option_id }}\" value=\"{{ option.product_option_value }}\">
                                  <label class=\"custom-control-label\" for=\"option-{{ option.product_option_id }}{{ loop.index }}\">{{   option_value.name }}</label>
                              </div>
                            {% endfor %}
                          </div>
