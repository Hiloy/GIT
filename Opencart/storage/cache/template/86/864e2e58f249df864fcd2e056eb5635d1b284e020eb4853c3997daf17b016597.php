...
class __TwigTemplate_0d678e83bf79728bece368ff9eb855fde93be2d15c144b00fd73a842c376edb5 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"modal-dialog modal-xl\" role=\"document\">
      ...
      <div class=\"modal-footer\">
        <table class=\"table table-bordered\">
          {% for total in totals %}
          <tr>
            <td class=\"text-left\"><strong>{{ total.title }}: </strong>{{ total.text }}</td>
