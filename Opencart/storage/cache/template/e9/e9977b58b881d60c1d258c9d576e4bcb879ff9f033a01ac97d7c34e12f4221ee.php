...
class __TwigTemplate_ae0541adfd6ba0e6672bec2094d90bc6a414429868481f441bf29675aef3a8f4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
    ...
    <div class=\"container-fluid\">
        ...
        echo "123\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-information\" class=\"form-horizontal\">
    ...
    <div class=\"container-fluid\">
        ...
        <div class=\"panel panel-default\">
            ...
            <div class=\"panel-body\">
                ...
                <form action=\"{{ action }}123\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-information\" class=\"form-horizontal\">
                    ...
                    <div class=\"form-group required\">
                        ...
                        <div class=\"col-sm-10\">
                            <input type=\"text\"
                                   ...
                                   id=\"input-title\" class=\"form-control\"
                                   value=\"{{ ctmenu_data ? ctmenu_data.title }}\" required>
                            {% if error_title %}
...
{{ footer }}", "extension/ctmenu/menu_form.twig", "");
    }
}
