...
class __TwigTemplate_d77f292af9db8978c7de57c5239bc0b2423318ee273e124e3059469e2ef5e0d5 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"row px-xl-5 pb-3\">
            <div class=\"col-lg-3 col-md-6 col-sm-12 pb-1\">
                <div class=\"d-flex align-items-center bg-light mb-4\" style=\"padding: 30px;\">
                    ...
                    <h5 class=\"font-weight-semi-bold m-0\">Якісна продукція</h5>
                </div>
            </div>
            <div class=\"col-lg-3 col-md-6 col-sm-12 pb-1\">
                <div class=\"d-flex align-items-center bg-light mb-4\" style=\"padding: 30px;\">
                    <h1 class=\"fa fa-shipping-fast text-primary m-0 mr-2\"></h1>
                    <h5 class=\"font-weight-semi-bold m-0\">Безкоштовна доставка</h5>
                </div>
            </div>
            <div class=\"col-lg-3 col-md-6 col-sm-12 pb-1\">
                <div class=\"d-flex align-items-center bg-light mb-4\" style=\"padding: 30px;\">
                    <h1 class=\"fas fa-exchange-alt text-primary m-0 mr-3\"></h1>
                    <h5 class=\"font-weight-semi-bold m-0\">Повернення протягом 14 днів</h5>
                </div>
            </div>
            <div class=\"col-lg-3 col-md-6 col-sm-12 pb-1\">
                <div class=\"d-flex align-items-center bg-light mb-4\" style=\"padding: 30px;\">
                    <h1 class=\"fa fa-phone-volume text-primary m-0 mr-3\"></h1>
                    <h5 class=\"font-weight-semi-bold m-0\">Підтримка 24/7</h5>
                </div>
            </div>
        </div>
    </div>
...
";
    ...
    {
        return array (  760 => 717,  43 => 3,  37 => 1,);
    }
