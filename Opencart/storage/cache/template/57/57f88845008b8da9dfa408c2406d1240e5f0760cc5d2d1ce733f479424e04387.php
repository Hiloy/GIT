...
class __TwigTemplate_a8cf872e95c632f369067d537742c82a4b34a208ec4e28eb6a1ea3985f79cf3e extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid\">
        ...
        echo "\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-information\" class=\"form-horizontal\">
                    ...
                    <div class=\"form-group required\">
                        <label class=\"col-sm-2 control-label\" for=\"input-title\">Назва ";
        // line 39
        ...
        <div class=\"panel panel-default\">
            ...
            <div class=\"panel-body\">
                ...
                <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-information\" class=\"form-horizontal\">
                    ...
                    <div class=\"form-group required\">
                        <label class=\"col-sm-2 control-label\" for=\"input-title\">Назва {{ entry_title }}</label>
                        <div class=\"col-sm-10\">
                            <input type=\"text\"
                                   name=\"ctmenu[title]\"
