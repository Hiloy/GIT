...
class __TwigTemplate_ae8a5aa0f90639da91b9d87c2b1ad9b74627203582264d41ed1485ce9000cd1e extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"panel-body\">
        ...
        if (($context["user_groups"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["user_group"]) {
                ...
                // line 50
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["user_group"], "user_group_id", [], "any", false, false, false, 50), ($context["selected"] ?? null))) {
                    // line 51
                    ...
                    // line 53
                    echo "                    <input type=\"checkbox\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["user_group"], "user_group_id", [], "any", false, false, false, 53);
                    echo "\" />
                    ";
                }
                // line 54
                echo "</td>
                  <td class=\"text-left\">";
                // line 55
                echo twig_get_attribute($this->env, $this->source, $context["user_group"], "name", [], "any", false, false, false, 55);
                echo "</td>
                  <td class=\"text-right\"><a href=\"";
                // line 56
                echo twig_get_attribute($this->env, $this->source, $context["user_group"], "edit", [], "any", false, false, false, 56);
                echo "\" data-toggle=\"tooltip\" title=\"";
...
{{ footer }} ", "user/user_group_list.twig", "");
    }
}
