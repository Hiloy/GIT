...
class __TwigTemplate_c76507abfedc458eafd98cd64b97e09f8279d39dcf6ded86ebaae78aad8a9ede extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container-fluid\">
        ...
        echo "\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-information\" class=\"form-horizontal\">
                    ...
                    <div class=\"form-group required\">
                        <label class=\"col-sm-2 control-label\" for=\"input-title\">112";
        // line 39
        ...
        <div class=\"panel panel-default\">
            ...
            <div class=\"panel-body\">
                ...
                <form action=\"{{ action }}\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-information\" class=\"form-horizontal\">
                    ...
                    <div class=\"form-group required\">
                        <label class=\"col-sm-2 control-label\" for=\"input-title\">112{{ entry_title }}</label>
                        <div class=\"col-sm-10\">
                            <input type=\"text\"
                                   name=\"ctmenu[title]\"
